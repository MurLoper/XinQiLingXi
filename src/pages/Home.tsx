...
const Home: React.FC<HomePageProps> = ({ isAdmin, currentSeason = 'spring', onNavigate, onLoginClick, onLogoutClick }) => {
  ...
  return (
    <div className="relative z-10 flex flex-col min-h-screen font-sans text-zen-brown w-full">
      <header className="sticky top-0 z-30 transition-all duration-300 w-full">
        <div className="absolute inset-0 -z-10 mask-gradient-to-b border-b border-white/20 transition-colors duration-1000"
      ...
      <footer className="mt-auto py-12 border-t border-zen-brown/5 flex flex-col items-center text-center bg-zen-base/30 w-full">
